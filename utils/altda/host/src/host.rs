...
use crate::{altda::SingleChainHostWithAltDA, witness_generator::AltDAWitnessGenerator};
...
impl OPSuccinctHost for AltDAOPSuccinctHost {
    type Args = SingleChainHostWithAltDA;
    ...
    async fn fetch(
    ...
    ) -> Result<SingleChainHostWithAltDA> {
        ...
        Ok(SingleChainHostWithAltDA::from_single_host(host))
    }
    ...
    async fn calculate_safe_l1_head(
        ...
        // For AltDA, use the same conservative offset as Ethereum DA.
