//! A program to verify a Optimism L2 block STF with AltDA in the zkVM.
//!
...
use op_succinct_client_utils::{
    witness::{preimage_store::PreimageStore, DefaultWitnessData, WitnessData},
    BlobStore,
};
...
fn main() {
    ...
    kona_proof::block_on(async move {
        ...
        run_range_program(AltDAWitnessExecutor::<PreimageStore, BlobStore>::new(), oracle, beacon)
            .await;
    });
}
